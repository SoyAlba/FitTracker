...
const _types = ['injection', 'supplement', 'medication', 'protein', 'water', 'gym', 'shopping', 'custom'];
const _typeLabels = ['Inyección', 'Suplemento', 'Medicación', 'Proteína', 'Agua', 'Gym', 'Lista compra', 'Personalizado'];
const _typeIcons = ['💉', '💊', '🏥', '🥤', '💧', '🏋️', '🛒', '🔔'];
  ...
  Future<void> _save() async {
    ...
    try {
      notifId = await NotificationService.instance.scheduleMedicalReminder(
        ...
        hour: _time.hour,
        minute: _time.minute,
        daily: _frequency == 'daily' || _frequency == 'weekdays' || _frequency == 'weekends',
      );
    } catch (_) {}
